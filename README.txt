...
Enter 'g++ ' plus the file name to compile. This will produce 'a.out'. a.out is an 
executable file that can be ran with './'.

I was unable to get the key generation to work properly. The right values are being 
...
This program can generate a key and write it to the key file, or you can not call 
the generate key function and use your own key file. 
